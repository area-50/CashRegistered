        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReversedJournalEntryId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ReversedJournalEntryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgencyNumber = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinancialAccounts_ChartOfAccounts_ChartOfAccountsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinancialDocuments_ChartOfAccounts_ChartOfAccountsId",
                        column: x => x.ChartOfAccountsId,
                        principalTable: "ChartOfAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FinancialDocuments_CostCenters_CostCenterId",
                        column: x => x.CostCenterId,
                        principalTable: "CostCenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FinancialDocuments_People_PersonId",
                        column: x => x.PersonId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FinancialDocuments_Users_ApprovalUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JournalEntryItems_ChartOfAccounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "ChartOfAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JournalEntryItems_CostCenters_CostCenterId",
                        column: x => x.CostCenterId,
                        principalTable: "CostCenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankStatementImports_FinancialAccounts_FinancialAccountId",
                        column: x => x.FinancialAccountId,
                        principalTable: "FinancialAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BankStatementImports_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinancialInstallments_FinancialDocuments_FinancialDocumentId",
            ...
            migrationBuilder.CreateTable(
                name: "FinancialCostCenterAllocations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    FinancialDocumentId = table.Column<int>(type: "integer", nullable: true),
                    JournalEntryItemId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinancialCostCenterAllocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FinancialCostCenterAllocations_CostCenters_CostCenterId",
                        column: x => x.CostCenterId,
                        principalTable: "CostCenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FinancialCostCenterAllocations_FinancialDocuments_Financial~",
                        column: x => x.FinancialDocumentId,
                        principalTable: "FinancialDocuments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FinancialCostCenterAllocations_JournalEntryItems_JournalEnt~",
                        column: x => x.JournalEntryItemId,
                        principalTable: "JournalEntryItems",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    FinancialInstallmentId = table.Column<int>(type: "integer", nullable: false),
                    FinancialAccountId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    InterestApplied = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    FineApplied = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    PaymentMethod = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    TransactionReceiptNumber = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentTransactions_FinancialAccounts_FinancialAccountId",
                        column: x => x.FinancialAccountId,
                        principalTable: "FinancialAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentTransactions_FinancialInstallments_FinancialInstallm~",
                        column: x => x.FinancialInstallmentId,
                        principalTable: "FinancialInstallments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentTransactions_JournalEntries_JournalEntryId",
                        column: x => x.JournalEntryId,
                        principalTable: "JournalEntries",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    Amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    FitId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankStatementItems_BankStatementImports_BankStatementImport~",
                        column: x => x.BankStatementImportId,
                        principalTable: "BankStatementImports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BankStatementItems_PaymentTransactions_PaymentTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankStatementImports_CreatedByUserId",
                table: "BankStatementImports",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BankStatementImports_FinancialAccountId",
                table: "BankStatementImports",
                column: "FinancialAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_BankStatementItems_BankStatementImportId",
                table: "BankStatementItems",
                column: "BankStatementImportId");

            migrationBuilder.CreateIndex(
                name: "IX_BankStatementItems_FitId",
                table: "BankStatementItems",
                column: "FitId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BankStatementItems_PaymentTransactionId",
                table: "BankStatementItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialAccounts_ChartOfAccountsId",
                table: "FinancialAccounts",
                column: "ChartOfAccountsId");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialCostCenterAllocations_CostCenterId",
                table: "FinancialCostCenterAllocations",
                column: "CostCenterId");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialCostCenterAllocations_FinancialDocumentId",
                table: "FinancialCostCenterAllocations",
                column: "FinancialDocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialCostCenterAllocations_JournalEntryItemId",
                table: "FinancialCostCenterAllocations",
                column: "JournalEntryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialDocuments_ApprovalUserId",
                table: "FinancialDocuments",
                column: "ApprovalUserId");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialDocuments_ChartOfAccountsId",
                table: "FinancialDocuments",
                column: "ChartOfAccountsId");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialDocuments_CostCenterId",
                table: "FinancialDocuments",
                column: "CostCenterId");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialDocuments_PersonId",
                table: "FinancialDocuments",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialInstallments_FinancialDocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalEntryItems_CostCenterId",
                table: "JournalEntryItems",
                column: "CostCenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_FinancialAccountId",
                table: "PaymentTransactions",
                column: "FinancialAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_FinancialInstallmentId",
                table: "PaymentTransactions",
                column: "FinancialInstallmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_JournalEntryId",
                table: "PaymentTransactions",
                column: "JournalEntryId");
        }
